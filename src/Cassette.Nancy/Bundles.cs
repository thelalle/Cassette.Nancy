...
namespace Cassette.Nancy {
    ...
    public static class Bundles {
        ...
        private static void AddScriptBundle(ScriptBundle bundle, string pageLocation, Action<ScriptBundle> customizeBundle) {
        ...
        private static IHtmlString Render<T>(string location) where T : Bundle {
