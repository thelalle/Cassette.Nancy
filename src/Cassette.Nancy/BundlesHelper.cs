...
// Copied (and modified) from Cassette.Views because Cassette.Views references System.Web for IHtmlString.
...
namespace Cassette.Nancy {
    ...
    public class BundlesHelper : IStartUpTask, IBundlesHelper {
        ...
        private readonly Func<IReferenceBuilder> getReferenceBuilder;
        private readonly IFileAccessAuthorization fileAccessAuthorization;
        ...
        public IHtmlString Render<T>(string location) where T : Bundle {
            return new NonEncodedHtmlString(getReferenceBuilder().Render<T>(location));
        }
        ...
        private void ThrowIfCannotRequestRawFile(string applicationRelativeFilePath, IFile file) {
        ...
        private static void ThrowIfFileNotFound(string applicationRelativeFilePath, IFile file) {
